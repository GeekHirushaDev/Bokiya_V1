module.exports = {
  ...
  getCommand: async (BokiyaDev, pika, prefix, startPing) => {
    const Config = require('../../config');
    const { plugin, myfunc, stylish } = require('../lib');
    const Ping = startPing - performance.now();
    const users = await myfunc.totalAnyaUsers();
    const caption = `\`\`\`
❖ ── ✦ ──『✙ Alive ✙』── ✦ ── ❖
...
💻 *Sᴏᴜʀᴄᴇ Cᴏᴅᴇ :* https://github.com/GeekHirushaDev/Bokiya_V1
🎀 *YᴏᴜTᴜʙᴇ :* https://youtube.com/@GeekHirusha
🔮 *Public Group :* https://chat.whatsapp.com/JX7Hl4vQej3AtH0C6CTM2l
