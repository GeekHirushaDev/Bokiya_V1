...
━─━─────༺ - ༻─────━─━
`;
      await BokiyaDev.sendMessage(pika.chat, { image: await getBuffer(data.image ? data.image : 'https://i.ibb.co/KzMpxyj/Picsart-23-11-20-18-29-20-073.jpg'), caption: caption }, { quoted: pika });
     }).catch((error) => {
       console.log(error);
