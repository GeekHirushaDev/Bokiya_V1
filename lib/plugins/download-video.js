module.exports = {
  ...
  getCommand: async (text, prefix, command, pika, BokiyaDev) => {
...
╰────────────────┈✧
`;
    await BokiyaDev.sendMessage(pika.chat, { video: await getBuffer(qualityUrl ? data.videoQuality.high : data.videoQuality.low), caption: caption }, { quoted: pika })
