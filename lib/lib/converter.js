...
/**
 * createVidSticker
 * @param buffer of the video media
 * @object return sticker's packname and author name
...
/**
 * writeExifInVid
 * @path path of the sticker buffer
 * @param metadata like packname and author's name
 * {@creator: https://github.com/PikaBotz}
 **/
exports.writeExifInVid = async (outputPath, metadata) => {
        const json = {
            "sticker-pack-id": `https://github.com/GeekHirushaDev/Bokiya_V1`,
