/**
   ...
   * @param pika, chatUpdate or shortcut module of BokiyaDev connection module
   * @param BokiyaDev connection module
   * {@creator: https://github.com/PikaBotz}
   **/
module.exports = {
  antiLink: async (userOwner, userSudo, userAdmin, botAdmin, pika, BokiyaDev) => {
    ...
    .then(() => {
      ...
      BokiyaDev.groupParticipantsUpdate(pika.chat, [pika.sender], 'remove');
    }).catch((error) => console.error(error));
  },
  antiPicture: async (userOwner, userSudo, userAdmin, botAdmin, pika, BokiyaDev) => {
  ...
  antiVideo: async (userOwner, userSudo, userAdmin, botAdmin, pika, BokiyaDev) => {
  ...
  antiToxic: async (userOwner, userSudo, userAdmin, botAdmin, pika, BokiyaDev) => {
